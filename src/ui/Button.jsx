...
const Button = ({ children, disabled, to, type, onClick }) => {
  ...
  const base =
    "bg-yellow-500 uppercase text-sm rounded-3xl hover:bg-red-600 hover:text-slate-300 mt-2 transition-colors duration-300 font-semibold tracking-wide focus:bg-red-500 focus:ring focus:outline-none focus:ring-offset-2 focus:ring-red-500 disabled:cursor-not-allowed disabled:bg-slate-400 ";

  const Styles = {
    primary: base + "  md:px-6 md:py-4 px-4 py-1.5 ",
    small: base + "px-4 py-2 md:px-5 md:py-2.5 text-xs",
    round: base + "px-2.5 py-1.5 md:px-5 md:py-2.5 text-xs",
    secondary:
