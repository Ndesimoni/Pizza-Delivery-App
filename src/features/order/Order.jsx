  ...
  return (
    <div className="px-4 py-6 space-y-8">
      <div className="flex flex-wrap   items-center justify-between gap-2">
        ...
        <div>
          {priority && <span className="bg-red-500 px-3 py-1 rounded-full text-xs text-yellow-50 mr-1 uppercase">Priority</span>}
          <span className="bg-green-500 px-3 py-1 rounded-full text-xs text-yellow-50 ml-1 uppercase">{status} order </span>
        </div>
      </div>
      ...
      <div className="flex flex-wrap   items-center justify-between gap-2 bg-stone-200 py-5 px-6">
        ...
        <p className="text-xs text-stone-50">(Estimated delivery: {formatDate(estimatedDelivery)})</p>
      </div>
